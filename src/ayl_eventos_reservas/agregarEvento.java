...
public class agregarEvento extends javax.swing.JFrame {
    ...
    public agregarEvento(int idCliente) {
        initComponents();
    ...
    private boolean guardarEvento(){
        ...
        if(gestor.registrarEvento(idCliente, fecha, horario, hora, cantAdultos, cantChicos, localidad, direccion, precio, señado, seña)){
            return true;
        }else{
            return false;
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agregarEvento(idCliente).setVisible(true);
            }
        });
    }
